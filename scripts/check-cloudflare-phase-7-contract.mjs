...
console.log('  Server error catalog read from the API contract and mapped in both directions');
console.log('  CF-P7-016: 29 codes, 5 closed presentations; inherited vocabularies match the code');
