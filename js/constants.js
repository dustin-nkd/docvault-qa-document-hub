...
const STRINGS = {
    ...
    moduleVocabHint: "Pick an existing module so coverage matches. Names match exactly, ignoring case.",
    runRegression: "Regression run",
    runRegressionHint: "Coverage & Impact only accepts regression runs as proof that a changed API was retested.",
    runRegressionBadge: "Regression",
    ...
    dragTaskHere: "Drag a card here, or use Move to",
    newTask: "New Task",
    dragBugHere: "Drag a card here, or use Move to",
