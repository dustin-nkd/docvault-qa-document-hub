...
Status: PASS — amended 2026-07-28. Recorded `PARTIAL — the lazy boundary, the artifact, and the deployment verdict` when written; the condition that held it short has since been cleared. See the amendment at the end.
...
said so.** What it measured was the lazy boundary and the artifact on the deployment, alongside a deployment verdict of 503. Nothing in it is withdrawn: those
