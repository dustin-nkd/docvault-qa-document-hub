...
Delivery status: `CF-P1-001` through `CF-P1-005` are complete. `CF-P1-006` is implemented and locally verified; production evidence is pending. Stories `CF-P1-007` through `CF-P1-009` have not started.
