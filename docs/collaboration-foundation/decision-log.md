...
| DL-025 | 2026-07-16 | Freeze one control plus 14 entity tables, exact canonical columns/owners, six immutable expansion migrations, ten prohibited patterns, and Critical/High invariant-to-evidence mappings. | Implemented; Gate P2-G1 review required | Technical Lead + Senior QA + Security + Operations + Product Owner | `CF-P2-001` policy/evidence passes locally without SQL, remote D1, binding, data, or activation. `CF-P2-002` remains blocked until explicit P2-G1 approval. |
