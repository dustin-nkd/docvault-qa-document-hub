...
| DL-016 | 2026-07-15 | Pin the Phase 1 Cloudflare toolchain, compatibility date, portable command dispatcher, CI Node major, and GitHub Actions commits before introducing Wrangler configuration. | Implemented; retained deployment evidence pending | Technical Lead + Operations + Security + Senior QA | `CF-P1-002` adds no runtime or remote resource; quarterly review is owned by Technical Lead and Operations. |
