...
describe('CF-P2-002 immutable Foundation migrations', () => {
    ...
    it('applies all twelve migrations once and exposes schema version twelve', async () => {
    ...
    it('creates exactly the frozen STRICT table columns with valid foreign keys', async () => {
        const expectedTables = [
            ...
            'retention_purge_runs', 'auth_rate_windows', 'device_mutation_results',
            'device_audit_events', 'workspace_key_rotations', 'workspace_key_rotation_targets'
        ];
