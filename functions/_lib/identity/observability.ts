...
export type IdentityOutcome = 'success' | 'rejected' | 'rate_limited' | 'provider_unavailable' | 'internal_error';
...
const ROUTES = new Set<IdentityRouteTemplate>(['/api/v1/oauth/github/transactions',
    '/api/v1/oauth/github/callback', '/api/v1/session', '/api/v1/session/logout']);
const OUTCOMES = new Set<IdentityOutcome>(['success', 'rejected', 'rate_limited', 'provider_unavailable', 'internal_error']);
